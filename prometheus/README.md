...
`thanosSidecar.image.tag` | name of Thanos container image tag | `v0.3.2` |
...
Thanos is a set of components that can be composed into a highly available metric system with unlimited storage capacity. It can be added seamlessly on top of existing Prometh
